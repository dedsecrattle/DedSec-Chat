...
const ChatBox = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-16 border border-blue-700">
      ...
      <div className="flex">
        <input type="text" placeholder="Type Your Message" className="py-4 rounded-lg"/>
